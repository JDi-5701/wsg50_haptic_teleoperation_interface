...
class WSG50TeleoperationInterface(Node):
    def __init__(self):
        ...
        self.declare_parameter('position_factor', 1.0)
        self.declare_parameter('force_feedback_ratio', 0.5)
        self.declare_parameter('clamp_force_threshold_max', 3.0)
        self.declare_parameter('clamp_force_threshold_min', 0.0)
        self.declare_parameter('force_offset', 0.0)
        self.declare_parameter('position_jump_threshold', 30)
        self.declare_parameter('force_deadzone', 0.1)
        self.declare_parameter('gripper_min_width', 5.0)
        ...
        self.gripper_position_current = 100.0
        self.gripper_position_target = 0.0
    ...
    def knob_state_callback(self, msg):
        ...
        if abs(self.knob_position_delta) > position_jump_threshold:
            ...
            self.position_change = position_factor * self.knob_position_delta
    ...
    def force_callback(self, msg):
        ...
        force_feedback = force_feedback_ratio * (msg.data - force_offset)
        ...
        force_msg = Float32()
        force_msg.data = float(force_feedback)
